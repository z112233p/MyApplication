...
import com.example.myapplication.datamodle.notice.template.Data
...
class Adapter_Notice() :RecyclerView.Adapter<Adapter_Notice.ViewHolder>() {
    private var dataList: MutableList<com.example.myapplication.datamodle.notice.notice_data.Data> = ArrayList()
    ...
    fun setData(dealData: List<com.example.myapplication.datamodle.notice.notice_data.Data>) {
