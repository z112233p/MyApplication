...
public class Adapter_Chat_Room_Message<MESSAGES extends IMessage > extends MessagesListAdapter<MESSAGES> {
    ...
    private static com.illa.joliveapp.adapter.holder.BaseMessageViewHolder.Payload payload;
...
//            Log.e("Peter","Adapter_Chat_Room_Message getMessagePositionById  "+((MESSAGE)wrapperPeter.item).getId());
    ...
    public void setPayload(com.illa.joliveapp.adapter.holder.BaseMessageViewHolder.Payload payload){
        this.payload = payload;
    }

    public com.illa.joliveapp.adapter.holder.BaseMessageViewHolder.Payload getPayload(){
        return payload;
    }
